...
import { GetLocationsQuery } from "@/__generated__";
  ...
  return (
    <section className="container sm:flex sm:flex-col sm:items-center sm:gap-20 flex flex-col items-center gap-10 ">
      ...
      <div className="flex gap-10 justify-center text-base  mt-10">
        <Link
          className={`p-5 hover:opacity-60 hover:scale-110 bg-white text-black rounded-2xl ${data.locations?.info?.prev == null ? "hidden" : ""}`}
          href={{
            pathname: "/locations",
            query: {
              ...(search ? { search } : {}),
        ...
        <Link
          className={`p-5 hover:opacity-60 hover:scale-110 bg-white text-black rounded-2xl ${data.locations?.info?.next == null ? "hidden" : ""}`}
          href={{
            pathname: "/locations",
            query: {
              ...(search ? { search } : {}),
